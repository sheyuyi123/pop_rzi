<template>
  <div class="dashboard-container">
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="13" style="padding-right:26px">
        ...
        <el-card class="box-card">
          ...
          <!-- 放置日历组件 -->
          <WorkCalendar :currend-data="new Date()" />
        </el-card>
        <!-- 公告 -->
        <el-card class="box-card">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            <el-button class="sideBtn" @click="showlizhi = true">加班离职</el-button>
    ...
    <el-dialog title="离职流程" :visible="showlizhi">
      <el-form ref="refForm" :model="ruleForm" :rules="rules" label-width="120px">
        <el-form-item label="离职时间" prop="exceptTime">
          <!-- <el-input size="small" style="width:80%;height:40px" prefix-icon="el-icon-timer" /> -->
          <template>
            <div class="block">
              <el-date-picker
        ...
        <el-form-item label="离职原因" prop="reason">
          <el-input v-model="ruleForm.reason" size="small" style="width:80%;height:40px" :rows="2" type="textarea" />
        </el-form-item>
      </el-form>
